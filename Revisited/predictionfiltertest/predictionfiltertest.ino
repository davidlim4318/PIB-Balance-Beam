...
const int n = 4;  // maximum filter order
float U[n + 1];
int Y[n + 1];
...
const int nF = 4;  // order of controller filter
int E[nF + 1];
...
// float bF[nF + 1] = {1, -1.974425425981427, 0.974536917461798};
// float aF[nF + 1] = {1, -1.499720530561673, 0.499860265280837};
float bF[nF + 1] = {0.036160917609104, -0.069982582276938, -0.002289075924749, 0.069982939403433, -0.033871484557860};
float aF[nF + 1] = {1, -3.527428196029189, 4.651331387874826, -2.717468084223680, 0.593565615506000};
